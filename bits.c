...
int bitCount(int x) {
  ...
  int mask = temp1+(temp1<<16);
  int temp2 = x & mask;
  int temp3 = (x>>1) & mask;
  x = temp2 + temp3;

  int temp5 = 0x33+(0x33 <<8);
  mask = mask +(mask<<16);
  temp2 =x&mask;
  temp3 =(x>>2)&mask;
  x= temp2+ temp3;
...
int isLessOrEqual(int x, int y) {
  ...
  int temp = negX+y;
  int shift = 0x01<<31;
  int temp1 = shift & temp;
  int temp2 = shift & x;
  int temp3 = shift & y;
  int test1 = !(temp3&(~temp2));
  int test2 =(~temp3)&temp2;
  int test3 = !temp1;
  int result = test3|!!(test2&test1);
  return result;
}
/* 
